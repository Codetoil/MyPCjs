<!--
 Original: author="Jeff Parsons (@jeffpar)" website="http://www.pcjs.org/" created="2012-05-05" modified="2016-04-15" license="http://www.gnu.org/licenses/gpl.html" 
 This : author="IAnthIsAwesome" website="https://github.com/IAnthIsAwesome/MyPCjs" created="2017-12-4" modified="2017-12-4" license="http://www.gnu.org/licenses/gpl.html" 
-->
...
<xsl:variable name="componentFile">
...
<xsl:choose>
<xsl:when test="$machineState != ''">
<xsl:value-of select="$machineState"/>
</xsl:when>
<xsl:otherwise>
...
<xsl:choose>
<xsl:when test="$component = 'machine'">
<xsl:value-of select="$machine"/>
.machine
</xsl:when>
<xsl:when test="$machine != '' and @id">
<xsl:value-of select="$machine"/>
.
<xsl:value-of select="@id"/>
</xsl:when>
...
<xsl:when test="@pos = 'left' or @pos = 'right'">
width:
<xsl:value-of select="@width"/>
;max-width:
<xsl:value-of select="@width"/>
...
<xsl:if test="@padRight">
padding-right:
<xsl:value-of select="@padRight"/>
;
</xsl:if>
<xsl:if test="@padBottom">
padding-bottom:
<xsl:value-of select="@padBottom"/>
;
</xsl:if>
<xsl:if test="@padLeft">
padding-left:
...
<xsl:if test="@background = 'default'">
background-color:
<xsl:value-of select="$BGNDCOLOR"/>
;
</xsl:if>
<xsl:if test="@background != 'default'">
background-color:
...
<xsl:if test="$APPCLASS = 'pcx86'">
<div class="{$CSSCLASS}-reference" style="padding-left:8px">
[
<a href="#" onclick="savePC('{$machine}'); return false;">Save Machine</a>
]
</div>
</xsl:if>
<div class="{$CSSCLASS}-copyright">
<a href="http://{$SITEHOST}" target="_blank">
<xsl:value-of select="$APPNAME"/>
</a>
v
<xsl:value-of select="$APPVERSION"/>
© 2012-2017 by
<a href="http://twitter.com/jeffpar" target="_blank">@jeffpar</a>
</div>
...
<xsl:otherwise>
<xsl:if test="$left = ''">float:left;</xsl:if>
</xsl:otherwise>
</xsl:choose>
</xsl:variable>
<xsl:variable name="style">
...
<xsl:if test="@type = 'container' and @class">
<xsl:text></xsl:text>
<xsl:value-of select="@class"/>
</xsl:if>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@size = 'large' or @size = 'small'">
font-size:
...
<xsl:choose>
<xsl:when test="@labelstyle">
<xsl:value-of select="@labelstyle"/>
</xsl:when>
<xsl:when test="@labelStyle">
<xsl:value-of select="@labelStyle"/>
</xsl:when>
...
<div class="{$CSSCLASS}-label" style="{$labelWidth}{$labelStyle}">
...
<canvas class="{$APPCLASS}-binding {$CSSCLASS}-canvas" width="{@width}" height="{@height}" style="-webkit-user-select:none;{$border}{$fontsize}{$style}" data-value="{{{$type},{$binding}}}">
<xsl:apply-templates/>
</canvas>
</xsl:when>
<xsl:when test="@type = 'button'">
<button class="{$APPCLASS}-binding" style="-webkit-user-select:none;{$border}{$width}{$height}{$fontsize}{$style}" data-value="{{{$type},{$binding},{$value}}}">
<xsl:apply-templates/>
</button>
</xsl:when>
...
<div class="{$APPCLASS}-binding {$CSSCLASS}-{@type}" data-value="{{{$type},{$binding},{$value}}}" style="display:inline-block;">
<xsl:value-of select="."/>
</div>
</xsl:when>
...
<div class="{$CSSCLASS}-{@type}-text" style="{$width}">
<xsl:apply-templates/>
</div>
...
<xsl:otherwise>
<div class="{$APPCLASS}-binding{$subClass} {$CSSCLASS}-{@type}" style="-webkit-user-select:none;{$border}{$width}{$height}{$fontsize}{$style}" data-value="{{{$type},{$binding}}}">
<xsl:apply-templates/>
</div>
</xsl:otherwise>
</xsl:choose>
...
<option value="{@path}" data-value="{{{$desc}}}">
<xsl:value-of select="$name"/>
</option>
</xsl:template>
...
<option value="{$files}" data-value="{{{$desc}}}">
<xsl:value-of select="@name"/>
</option>
</xsl:template>
...
<xsl:if test="@href">
<option value="{@href}" data-value="{{{$link}}}">
<xsl:value-of select="$name"/>
</option>
</xsl:if>
...
<option value="{$files}" data-value="{{{$link}}}">
<xsl:value-of select="$name"/>
</option>
</xsl:if>
</xsl:if>
...
<xsl:template match="control"></xsl:template>
...
<xsl:apply-templates select="document($componentFile)/cpu">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@stepping">
<xsl:value-of select="@stepping"/>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@autostart">
<xsl:value-of select="@autostart"/>
</xsl:when>
<xsl:when test="@autoStart">
<xsl:value-of select="@autoStart"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@addrReset">
<xsl:value-of select="@addrReset"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@csstart">
<xsl:value-of select="@csstart"/>
</xsl:when>
<xsl:when test="@csStart">
<xsl:value-of select="@csStart"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@csinterval">
<xsl:value-of select="@csinterval"/>
</xsl:when>
<xsl:when test="@csInterval">
<xsl:value-of select="@csInterval"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@csstop">
<xsl:value-of select="@csstop"/>
</xsl:when>
<xsl:when test="@csStop">
<xsl:value-of select="@csStop"/>
</xsl:when>
...
<xsl:apply-templates select="document($componentFile)/fpu">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/chipset">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@scaleTimers">
<xsl:value-of select="@scaleTimers"/>
</xsl:when>
<xsl:when test="@scaletimers">
<xsl:value-of select="@scaletimers"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@floppies">
<xsl:value-of select="@floppies"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@dateRTC">
<xsl:value-of select="@dateRTC"/>
</xsl:when>
<xsl:when test="@rtcdate">
<xsl:value-of select="@rtcdate"/>
</xsl:when>
<xsl:when test="@rtcDate">
<xsl:value-of select="@rtcDate"/>
</xsl:when>
...
<xsl:with-param name="machine" select="$machine"/>
<xsl:with-param name="mount">
<xsl:if test="@autoMount">
<xsl:value-of select="@autoMount"/>
</xsl:if>
<xsl:if test="@automount">
<xsl:value-of select="@automount"/>
</xsl:if>
...
<xsl:choose>
<xsl:when test="@baudReceive">
<xsl:value-of select="@baudReceive"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@baudTransmit">
<xsl:value-of select="@baudTransmit"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:apply-templates select="document($componentFile)/keyboard">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/parallel">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/serial">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@charbol">
<xsl:value-of select="@charbol"/>
</xsl:when>
<xsl:when test="@charBOL">
<xsl:value-of select="@charBOL"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@tabsize">
<xsl:value-of select="@tabsize"/>
</xsl:when>
<xsl:when test="@tabSize">
<xsl:value-of select="@tabSize"/>
</xsl:when>
...
<xsl:apply-templates select="document($componentFile)/mouse">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@scaleMouse">
<xsl:value-of select="@scaleMouse"/>
</xsl:when>
...
<xsl:apply-templates select="document($componentFile)/hdc">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/rom">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/ram">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@screencolor">
<xsl:value-of select="@screencolor"/>
</xsl:when>
<xsl:when test="@screenColor">
<xsl:value-of select="@screenColor"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@screenRotate">
<xsl:value-of select="@screenRotate"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferAddr">
<xsl:value-of select="@bufferAddr"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferRAM">
<xsl:value-of select="@bufferRAM"/>
</xsl:when>
<xsl:otherwise>false</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferFormat">
<xsl:value-of select="@bufferFormat"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@bufferCols">
<xsl:value-of select="@bufferCols"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferRows">
<xsl:value-of select="@bufferRows"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferBits">
<xsl:value-of select="@bufferBits"/>
</xsl:when>
<xsl:otherwise>1</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferLeft">
<xsl:value-of select="@bufferLeft"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@bufferRotate">
<xsl:value-of select="@bufferRotate"/>
</xsl:when>
<xsl:otherwise>0</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@switches">
<xsl:value-of select="@switches"/>
</xsl:when>
<xsl:otherwise/>
</xsl:choose>
</xsl:variable>
...
<xsl:value-of select="@cellHeight"/>
</xsl:when>
<xsl:otherwise>1</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:when test="@charCols">
<xsl:value-of select="@charCols"/>
</xsl:when>
...
<xsl:when test="@charRows">
<xsl:value-of select="@charRows"/>
</xsl:when>
...
<xsl:when test="@fontrom">
<xsl:value-of select="@fontrom"/>
</xsl:when>
<xsl:when test="@fontROM">
<xsl:value-of select="@fontROM"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@autolock">
<xsl:value-of select="@autolock"/>
</xsl:when>
<xsl:when test="@autoLock">
<xsl:value-of select="@autoLock"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@smoothing">
<xsl:value-of select="@smoothing"/>
</xsl:when>
<xsl:otherwise>null</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:choose>
<xsl:when test="@refreshRate">
<xsl:value-of select="@refreshRate"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@flicker">
<xsl:value-of select="@flicker"/>
</xsl:when>
<xsl:otherwise>0.5</xsl:otherwise>
</xsl:choose>
</xsl:variable>
...
<xsl:apply-templates select="document($componentFile)/debugger">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:apply-templates select="document($componentFile)/panel">
<xsl:with-param name="machine" select="$machine"/>
</xsl:apply-templates>
</xsl:template>
...
<xsl:choose>
<xsl:when test="@autopower">
<xsl:value-of select="@autopower"/>
</xsl:when>
<xsl:when test="@autoPower">
<xsl:value-of select="@autoPower"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@buswidth">
<xsl:value-of select="@buswidth"/>
</xsl:when>
<xsl:when test="@busWidth">
<xsl:value-of select="@busWidth"/>
</xsl:when>
...
<xsl:choose>
<xsl:when test="@resume and $machineState = ''">
